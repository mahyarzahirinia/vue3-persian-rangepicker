...
export function useDatePicker(
  props: DatePickerPropsWithDefaults,
  emit: EmitType,
  refs: {
    root: Ref<HTMLElement | null>;
    inputsRef: Ref<HTMLInputElement[]>;
    pdpPicker: Ref<HTMLElement | null>;
    pdpSelectYear: Ref<HTMLElement | null>;
    pdpMain: Ref<HTMLElement | null>;
  },
  rawAttrs: Record<string, unknown>,
) {
  const isClient: boolean = typeof window !== 'undefined';

  const { root, inputsRef, pdpPicker, pdpSelectYear, pdpMain } = refs;
